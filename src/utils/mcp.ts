 ...
 */
export async function sampleMessage(server: any, prompt: string, systemPrompt?: string): Promise<string | null> {
    try {
 ...
 */
export async function handleToolError(server: any, error: any, context: string): Promise<{ content: { type: "text", text: string }[], isError: true }> {
